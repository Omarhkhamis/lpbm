...
import { hollywoodSmileDefaults } from "../../../../../../lib/sectionDefaultsHollywood";
import WhatsAppTriggerButton from "../../../../components/WhatsAppTriggerButton";

export default function HollywoodSmileSec({ data, whatsappLink }) {
  const content = data || hollywoodSmileDefaults;
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="relative z-10  lg:max-w-4xl space-y-6 py-8 lg:pr-24 lg:py-24">
            ...
            <WhatsAppTriggerButton
              href={whatsappLink}
              trackingName="hollywood_smile_main_section_cta"
