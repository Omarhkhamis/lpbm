...
export const updateSectionAction = async (site, key, formData) => {
  ...
  try {
    ...
    redirect(
      `/admin90/sections/${key}?site=${siteId}&error=1&locale=${localeParam}`
    );
  }
  ...
  redirect(
    `/admin90/sections/${key}?site=${siteId}&saved=1&locale=${localeParam}`
  );
};
...
export const toggleSectionAction = async (site, key, locale = "en") => {
  ...
  redirect(`/admin90/sections/${key}?site=${siteId}&locale=${lang}`);
};
...
export const updateGeneralSettingsAction = async (site, formData) => {
  ...
  try {
    ...
    redirect(`/admin90/general?site=${siteId}&error=1`);
  }
...
export const updateFooterSettingsAction = async (site, formData) => {
  ...
  try {
    ...
    redirect(`/admin90/footer?site=${siteId}&error=1&locale=${locale}`);
  }

  revalidatePath(`/admin90/footer`);
  revalidatePublic(siteId, locale);
  redirect(`/admin90/footer?site=${siteId}&saved=1&locale=${locale}`);
};
...
export const updateSeoSettingsAction = async (site, formData) => {
  ...
  try {
    ...
    redirect(`/admin90/seo?site=${siteId}&error=1&locale=${locale}`);
  }

  revalidatePublic(siteId, locale);
  redirect(`/admin90/seo?site=${siteId}&saved=1&locale=${locale}`);
};
...
export const updatePageAction = async (site, slug, formData) => {
  ...
  try {
    ...
    redirect(`/admin90/pages/${slug}?site=${siteId}&error=1`);
  }

  revalidatePath(`/admin90/pages/${slug}`);
  revalidatePath(`/${slug}`);
  redirect(`/admin90/pages/${slug}?site=${siteId}&saved=1`);
};
...
export const createAdminUserAction = async (site, formData) => {
  ...
  try {
    ...
    if (!email || password.length < 6) {
      redirect(`/admin90/admin-users?site=${siteId}&error=1`);
    }
  ...
  redirect(`/admin90/admin-users?site=${siteId}&saved=1`);
};
...
export const reorderSectionsAction = async (site, formData) => {
  ...
  revalidatePath(`/admin90/sections`);
  revalidatePublic(siteId, locale);
  redirect(`/admin90/sections?site=${siteId}&reordered=1&locale=${locale}`);
};
