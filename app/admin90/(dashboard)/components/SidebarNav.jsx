...
export default function SidebarNav({
  ...
  const dataParams = new URLSearchParams({ site });
  ...
  return (
    <nav className="mt-8 space-y-6">
      ...
      <CollapsibleNavGroup
        title="Data - Leads"
        items={[
          { label: "Spin Data", href: `${prefix}/spin-data?${dataQuery}` },
          { label: "Form Data", href: `${prefix}/form-data?${dataQuery}` }
        ]}
      ...
      {!isDataViewer ? (
        <CollapsibleNavGroup
          ...
          items={[
            ...
            { label: "Popup Form", href: `${prefix}/popup-form?${siteQuery}` },
            { label: "Footer", href: `${prefix}/footer?${baseQuery}` },
