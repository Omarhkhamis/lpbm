...
export const popularTreatmentsDefaults = {
  ...
  ctaHref: "https://wa.me/+905382112583",
  readMoreLabel: "Read more",
  faqTitle: "Frequently Asked Questions",
  consultationText: "If you have any questions, contact us.",
      ...
      faqs: [
        {
          ...
          answer:
            "Most full-arch workflows are completed in planned stages over a few visits, depending on diagnostics and healing."
        },
        {
          question: "Is this option suitable for everyone?",
          answer:
            "Suitability is confirmed after clinical evaluation and imaging by the implant team."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer:
            "Yes. Crowns are designed to match surrounding teeth in shade, contour and bite."
        },
        {
          question: "Can I return to normal routine quickly?",
          answer:
            "Most patients resume daily activities shortly after the procedure, based on the dentist's instructions."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          question: "What are the advantages over removable dentures?",
          answer:
            "Implant-supported bridges are fixed, more stable while eating, and feel closer to natural teeth."
        },
        {
          question: "How do I maintain the bridge?",
          answer:
            "Regular oral hygiene and scheduled check-ups are key for long-term success."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          question: "Why is grafting sometimes required?",
          answer:
            "It helps rebuild bone volume when natural support is insufficient for safe implant placement."
        },
        {
          question: "Does grafting delay final restoration?",
          answer:
            "Treatment timing varies by case and healing response; your doctor confirms the plan after assessment."
        }
      ]
    }
  ]
...
export const teamMembersDefaults = {
  ...
  readMoreLabel: "Read more",
  expertiseTitle: "Doctor experience",
  consultationText: "If you have any questions, contact us.",
  contactButtonLabel: "Contact us",
  closeLabel: "Close",
  items: [
    {
      ...
      bio: "Specialized in smile makeovers and personalized veneer planning for international patients.",
      expertise:
        "12+ years in aesthetic dentistry\nDigital smile design planning\nMinimally invasive veneer protocols",
    ...
    },
    {
      ...
      bio: "Focuses on complex implant-supported restorations and full-arch rehabilitation.",
      expertise:
    ...
    },
    {
      ...
      bio: "Ensures each patient receives clear guidance and fast communication before and after treatment.",
      expertise:
    ...
    },
    {
      ...
      bio: "Supports clinicians during procedures and helps maintain high clinical hygiene standards.",
      expertise:
        "Chairside clinical support\nSterilization workflow control\nPatient comfort assistance",
...
export const healthTourismDefaults = {
  ...
  description:
    "From first message to final check-up, our team guides you through a seamless implant journey at BM TURKIYE.",
  steps: [
    {
      icon: "fa-comments",
      label: "STEP 1",
...
const IMPLANT_MATRIX_RU_TRANSLATIONS = {
  technique: {
    "Single Implant": "Одиночный имплант",
    "All-on-4 / All-on-6": "All-on-4 / All-on-6",
    "Zirconium Implant Crowns": "Циркониевые коронки на имплантах",
    "Bone Grafting": "Костная пластика",
    "Immediate Implants": "Немедленные импланты",
    "Digital Implant Planning": "Цифровое планирование имплантации"
  },
  type: {
    "Titanium post + crown": "Титановый имплант + коронка",
    "Full-arch prosthesis on implants": "Полноарочный протез на имплантах",
    "Ceramic crown on implant": "Керамическая коронка на импланте",
    "Graft material + healing": "Костный материал + заживление",
    "Extraction + implant + temp tooth": "Удаление + имплант + временный зуб",
    "3D imaging + guided surgery": "3D-снимки + навигационная хирургия"
  },
  candidates: {
    "1–3 missing teeth": "1–3 отсутствующих зуба",
    "Fully edentulous or failing dentition":
      "Полное отсутствие зубов или сильно разрушенный зубной ряд",
    "Aesthetic zones, cosmetic focus":
      "Эстетические зоны, косметический фокус",
    "Patients with jawbone loss": "Пациенты с дефицитом костной ткани",
    "Select patients with healthy bone":
      "Отдельные пациенты с достаточным объемом кости",
    "All implant patients": "Все пациенты для имплантации"
  },
  advantages: {
    "Natural feel, independent support":
      "Естественные ощущения, независимая опора",
    "Fixed, stable, full set of teeth":
      "Фиксированный стабильный полный зубной ряд",
    "Highly aesthetic, metal-free": "Высокая эстетика, без металла",
    "Enables implants in difficult cases":
      "Позволяет установить импланты в сложных случаях",
    "No waiting period, instant teeth":
      "Без периода ожидания, зубы сразу",
    "Safe, accurate, less invasive": "Безопасно, точно, менее инвазивно"
  },
  disadvantages: {
    "Minor surgery, healing time": "Небольшая операция и время заживления",
    "Requires healing period": "Требуется период заживления",
    "Higher cost": "Более высокая стоимость",
    "Healing time required": "Требуется время на заживление",
    "Not suitable for everyone": "Подходит не всем",
    "Adds planning step": "Добавляет этап планирования"
  },
  timeInTurkey: {
    "5–7 days + healing": "5–7 дней + заживление",
    "7–10 days": "7–10 дней",
    "5–7 days": "5–7 дней",
    "1–2 days (plus healing)": "1–2 дня (+ заживление)",
    "1–2 days": "1–2 дня",
    "Same day (planning)": "В тот же день (планирование)"
  },
  results: {
    "Lifelong with proper care": "Долговечно при правильном уходе",
    "Full-arch smile with high stability":
      "Полноарочная улыбка с высокой стабильностью",
    "Natural look, strong bite": "Естественный вид, крепкий прикус",
    "Strong foundation for implants": "Надежная основа для имплантов",
    "Instant smile, long-term solution":
      "Быстрая улыбка, долгосрочное решение",
    "Precise implant placement": "Точная установка имплантов"
  }
};

const hasCyrillic = (value) => /[А-Яа-яЁё]/.test(String(value || ""));

const translateImplantMatrixValue = (field, value) =>
  IMPLANT_MATRIX_RU_TRANSLATIONS[field]?.[value] || value || "";

const buildImplantMatrixValues = (row) =>
  IMPLANT_MATRIX_FIELDS.map((field) => row[field] || "");

const localizeImplantMatrixRowToRu = (row) => {
  const localized = { ...row };
  for (const field of IMPLANT_MATRIX_FIELDS) {
    localized[field] = translateImplantMatrixValue(field, row[field]);
  }
  localized.values = buildImplantMatrixValues(localized);
  return localized;
};

export const normalizeImplantMatrixDataForLocale = (data, locale = "en") => {
  const lang = normalizeLocale(locale);
  if (lang !== "ru" || !data || typeof data !== "object") return data;
  ...
  const rows = data.rows.map((row, rowIndex) => {
    ...
    const valuesContainRussian = values.some(hasCyrillic);
    const englishDefaultValues = implantMatrixDefaults.rows[rowIndex]?.values || [];
    const hasDefaultEnglishValues =
      englishDefaultValues.length > 0 &&
      englishDefaultValues.every((value, index) => values[index] === value);
    const rowHasTranslatableEnglish = IMPLANT_MATRIX_FIELDS.some((field) => {
      const currentValue = row[field];
      return (
        typeof currentValue === "string" &&
        Boolean(currentValue) &&
        translateImplantMatrixValue(field, currentValue) !== currentValue
      );
    });

    if (
      valuesContainRussian ||
      (!hasDefaultEnglishValues && !rowHasTranslatableEnglish)
    ) {
      return row;
    }

    const nextRow = { ...row };
    for (const [index, field] of IMPLANT_MATRIX_FIELDS.entries()) {
      const currentFieldValue = row[field];
      const localizedFieldValue =
        typeof currentFieldValue === "string" && currentFieldValue
          ? translateImplantMatrixValue(field, currentFieldValue)
          : "";
      nextRow[field] =
        localizedFieldValue || translateImplantMatrixValue(field, values[index]);
    }
    nextRow.values = IMPLANT_MATRIX_FIELDS.map((field, index) => {
      const localizedFieldValue = nextRow[field];
      if (localizedFieldValue) return localizedFieldValue;
      return translateImplantMatrixValue(field, values[index]);
    });
    changed = true;
    return nextRow;
  });
...
export const DENTAL_SECTION_DEFAULTS_EN = {
  ...
  trustpilotReviews: trustpilotReviewsDefaults,
  faqs: faqsDefaults
};
...
export const DENTAL_SECTION_DEFAULTS_RU = {
  ...
  popularTreatments: {
    ...
    consultationText: "Если у вас есть вопросы, свяжитесь с нами.",
    contactButtonLabel: "Свяжитесь с нами",
    closeLabel: "Закрыть",
    items: [
      {
        title: "All-on-4 / All-on-6",
        ...
        faqs: [
          {
            ...
            answer:
              "Обычно лечение проходит поэтапно в несколько визитов, в зависимости от диагностики и заживления."
          },
          {
            question: "Подходит ли это всем пациентам?",
            answer:
              "Окончательная пригодность подтверждается после осмотра и снимков."
          }
        ]
      },
      {
        ...
        faqs: [
          {
            question: "Будет ли имплант выглядеть естественно?",
            answer:
              "Да, коронки подбираются по цвету и форме под соседние зубы."
          },
          {
            question: "Когда можно вернуться к обычному ритму?",
            answer:
              "Большинство пациентов быстро возвращаются к повседневной активности по рекомендациям врача."
          }
        ]
      },
      {
        ...
        faqs: [
          {
            question: "Какие преимущества перед съёмным протезом?",
            answer:
              "Мост на имплантах фиксирован, более стабилен при жевании и ощущается естественнее."
          },
          {
            question: "Как ухаживать за мостом?",
            answer:
              "Важно соблюдать гигиену и проходить регулярные контрольные осмотры."
          }
        ]
      },
      {
        ...
        faqs: [
          {
            question: "Зачем нужна костная пластика?",
            answer:
              "Она помогает восстановить объём кости, если его недостаточно для стабильной установки импланта."
          },
          {
            question: "Увеличивает ли это общий срок лечения?",
            answer:
              "Срок зависит от клинической ситуации и заживления; точный план даёт врач после диагностики."
          }
        ]
      }
    ]
    ...
    items: [
      {
        ...
        bio: "Специализируется на эстетических кейсах и индивидуальном планировании улыбки для международных пациентов.",
        expertise:
          "12+ лет в эстетической стоматологии\nЦифровое планирование улыбки\nМинимально инвазивные протоколы виниров",
        image: "/uploads/team/dr-selin.jpg",
        alt: "Д-р Селин"
      },
      {
        ...
        bio: "Сфокусирован на сложных имплантологических случаях и полном восстановлении функции и эстетики.",
        expertise:
          "Полноарочная имплантация\nПродвинутое планирование имплантов\nФункциональное восстановление прикуса",
        image: "/uploads/team/dr-emir.jpg",
        alt: "Д-р Эмир"
      },
      {
        ...
        bio: "Сопровождает пациента на всех этапах лечения и обеспечивает быструю коммуникацию с клиникой.",
        expertise:
          "Координация международных пациентов\nПланирование лечебного маршрута\nПоддержка до и после лечения",
        image: "/uploads/team/elif.jpg",
        alt: "Элиф"
      },
      {
        ...
        bio: "Ассистирует врачу во время процедур и поддерживает высокие стандарты клинической гигиены.",
        expertise:
          "Клиническая ассистенция\nКонтроль стерилизационных процессов\nПоддержка комфорта пациента",
        image: "/uploads/team/mert.jpg",
        alt: "Мерт"
      }
    ]
  ...
  healthTourism: {
    ...
    description:
      "От первого сообщения до финального чекапа — сопровождаем весь путь лечения в BM TURKIYE.",
    steps: [
      {
        icon: "fa-comments",
        label: "ШАГ 1",
  ...
  implantMatrix: {
    ...
    rows: implantMatrixDefaults.rows.map(localizeImplantMatrixRowToRu)
  },
  techniquesUsed: {
  ...
  trustpilotReviews: {
    ...
    kicker: "Отзывы Trustpilot",
    title: "Реальные истории пациентов",
    description:
      "Что говорят международные пациенты об опыте в BM TÜRKIEY.",
    ratingCountLabel: "380+ отзывов",
    ctaText: "Бесплатная консультация →",
    items: trustpilotReviewsDefaults.items.map((item) => ({
      ...item,
      text: item.text
    }))
  },
...
const HOLLYWOOD_SECTION_DEFAULTS_RU = {
  ...HOLLYWOOD_SECTION_DEFAULTS_EN,
  popularTreatments: {
    ...HOLLYWOOD_SECTION_DEFAULTS_EN.popularTreatments,
    kicker: "Популярные услуги",
    title: "Самые востребованные процедуры",
    description:
      "Подборка популярных эстетических и восстановительных процедур для международных пациентов.",
    readMoreLabel: "Подробнее",
    faqTitle: "Часто задаваемые вопросы",
    consultationText: "Если у вас есть вопросы, свяжитесь с нами.",
    contactButtonLabel: "Свяжитесь с нами",
    ...
    items: [
      {
        ...
        description:
          "Современные имплантологические решения для восстановления функции и эстетики с долгосрочной стабильностью.",
        image: "/uploads/hollywood-smile/sec-dental-implant.jpg",
        alt: "Дентальные импланты",
        faqs: [
          {
            question: "Можно ли сочетать импланты и эстетическое лечение?",
            answer:
              "Да, в ряде случаев план включает имплантацию и эстетические этапы для функционального и визуального результата."
          },
          {
            question: "Как подтверждается пригодность лечения?",
            answer:
              "После очного осмотра и диагностики врач утверждает безопасный и эффективный план."
          }
        ]
      },
      {
        ...
        description:
          "Прочные циркониевые реставрации с естественной прозрачностью и гармоничной эстетикой.",
        image: "/uploads/hollywood-smile/zirkonyum-veneers.jpg",
        alt: "Циркониевые коронки",
        faqs: [
          {
            question: "Насколько они долговечны?",
            answer:
              "Циркониевые коронки отличаются высокой прочностью и служат долго при правильном уходе."
          },
          {
            question: "Будут ли коронки выглядеть естественно?",
            answer:
              "Да, современные материалы позволяют добиться натурального внешнего вида."
          }
        ]
      },
      {
        title: "Виниры E-Max и композитные виниры",
        description:
          "Минимально инвазивные варианты для улучшения цвета, формы и симметрии улыбки.",
        image: "/uploads/hollywood-smile/sec-veneers.jpg",
        alt: "Виниры E-Max и композитные виниры",
        faqs: [
          {
            question: "В чем разница между E-Max и композитом?",
            answer:
              "E-Max обеспечивает премиальную керамическую эстетику, композит — более консервативный и гибкий вариант."
          },
          {
            question: "Требуется ли сильная обточка зубов?",
            answer:
              "Во многих случаях подготовка минимальна и зависит от исходной клинической ситуации."
          }
        ]
      },
      {
        ...
        description:
          "Премиальный дизайн улыбки с акцентом на гармонию лица и максимально естественный результат.",
        image: "/uploads/hollywood-smile/ultra-aesthetic-veneers.jpg",
        alt: "Ultra Aesthetic Veneers",
        faqs: [
          {
            question: "Кому подходит эта процедура?",
            answer:
              "Пациентам, которым важен индивидуальный, детально проработанный эстетический результат."
          },
          {
            question: "Как выбирается финальный вид улыбки?",
            answer:
              "Через совместное планирование с врачом с учетом анатомии лица и ваших ожиданий."
          }
        ]
      }
    ]
  },
  luckySpin: DENTAL_SECTION_DEFAULTS_RU.luckySpin,
  certificatesGallery: DENTAL_SECTION_DEFAULTS_RU.certificatesGallery
};
